...
}>>(routeConfig: import("@react-navigation/compat/lib/typescript/src/types").CompatRouteConfig<NavigationPropType, NavigationPropType extends import("@react-navigation/native").NavigationProp<infer P_1, any, any, any, any> ? P_1 : Record<string, object | undefined>>, navigationConfig?: Partial<Pick<NavigationConfig, Exclude<keyof NavigationConfig, "screenOptions">>> & {
