...
<<<<<<< HEAD:kiswa/node_modules/react-native-gesture-handler/android/src/main/java/com/swmansion/gesturehandler/core/GestureHandler.kt
...
=======
    val event = if (BuildConfig.DEBUG) {
      ...
      try {
        adaptEvent(origEvent)
>>>>>>> main:kiswa/node_modules/react-native-gesture-handler/android/lib/src/main/java/com/swmansion/gesturehandler/GestureHandler.kt
